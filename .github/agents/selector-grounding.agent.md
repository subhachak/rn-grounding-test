...
- To generate/export/save the registry, call with `save: true` (optional `output`, default `registry.json` in the output folder). Report the path and summary counts; don't read the file back.
